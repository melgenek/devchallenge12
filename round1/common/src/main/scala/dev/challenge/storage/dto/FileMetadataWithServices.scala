...
case class FileMetadataWithServices(fileId: String,
                                    version: String,
                                    fileName: String,
                                    contentType: ContentType,
                                    serviceIds: List[String])

trait FileMetadataWithServicesProtocol extends DefaultJsonProtocol {
  ...
  implicit val fmwsFormat: RootJsonFormat[FileMetadataWithServices] = jsonFormat5(FileMetadataWithServices)
